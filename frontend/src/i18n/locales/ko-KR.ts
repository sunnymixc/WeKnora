export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "중산병원 신장내과 지능형 Q&A 플랫폼에 오신 것을 환영합니다",
        desc: "몇 단계만으로 지식 베이스, 대화, 에이전트의 핵심 사용법을 안내합니다. '다음'을 눌러 시작하세요.",
      },
      knowledge: {
        title: "지식 베이스 만들기",
        desc: "모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 플랫폼이 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.",
      },
      chat: {
        title: "AI 대화 시작하기",
  ...
  localImport: {
    menuLabel: "서버에서 가져오기",
    title: "서버 로컬 파일 시스템에서 가져오기",
    root: "루트 디렉터리",
    empty: "이 디렉터리는 비어 있습니다",
    manualLabel: "경로 직접 입력",
    manualPlaceholder: "가져오기 루트 기준 상대 경로, 예: docs/report.pdf",
    manualTip: "경로는 서버에 설정된 가져오기 루트 디렉터리 기준이며 그 범위를 벗어날 수 없습니다",
    loadFailed: "디렉터리 로드 실패",
    selectRequired: "파일을 선택하거나 파일 경로를 입력하세요",
    importSuccess: "로컬 파일을 가져왔습니다",
    importFailed: "로컬 파일 가져오기 실패",
  },
  uploadConfirm: {
    title: "문서 업로드 확인",
    fileList: "업로드할 파일",
    ...
    localItemLabel: "서버 로컬 파일",
    localAdded: "로컬 파일이 추가되었습니다",
    localDuplicate: "이 로컬 파일은 이미 목록에 있습니다",
  ...
  settings: {
    ...
    weknoraCloud: {
      ...
      addModelsDisplayName: {
        chat: '관리형 서비스 대화',
        embedding: '관리형 서비스 Embedding',
        rerank: '관리형 서비스 ReRank',
        vllm: '관리형 서비스 비전',
      },
    },
    system: "시스템 설정",
  ...
  initialization: {
    title: "초기화",
    welcome: "중산병원 신장내과 지능형 Q&A 플랫폼에 오신 것을 환영합니다",
  ...
  createChat: {
    title: "안녕하세요, 중산병원 신장내과 지능형 Q&A 도우미입니다",
