export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать на платформу Q&A нефрологии больницы Чжуншань',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и платформа автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  localImport: {
    menuLabel: 'Импорт с сервера',
    title: 'Импорт из локальной файловой системы сервера',
    root: 'Корневой каталог',
    empty: 'Каталог пуст',
    manualLabel: 'Ввести путь вручную',
    manualPlaceholder: 'Путь относительно корня импорта, например docs/report.pdf',
    manualTip: 'Путь задаётся относительно настроенного на сервере корня импорта и не может выходить за его пределы',
    loadFailed: 'Не удалось загрузить каталог',
    selectRequired: 'Выберите файл или укажите путь к файлу',
    importSuccess: 'Локальный файл успешно импортирован',
    importFailed: 'Не удалось импортировать локальный файл',
  },
  uploadConfirm: {
    ...
    localItemLabel: 'Локальный файл сервера',
    localAdded: 'Локальный файл добавлен',
    localDuplicate: 'Этот локальный файл уже в списке',
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Управляемый сервис парсинга',
      description: 'Настройте учётные данные APPID и APPSECRET для управляемого сервиса моделей и парсинга документов.',
      ...
      expired: 'Учётные данные управляемого сервиса истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения управляемого сервиса',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения управляемого сервиса',
      ...
      usageSteps: '1. Сохраните APPID и APPSECRET\n2. Добавьте chat, embedding, rerank и vlm в разделе «Облачные модели» ниже\n3. Парсинг: Настройки БЗ → Движок парсинга → Управляемый сервис парсинга',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные управляемого сервиса настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные управляемого сервиса не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные управляемого сервиса настроены. Поддерживаемые модели см. в',
      modelHintDocsLink: 'документации API',
      modelsSection: {
        title: 'Облачные модели',
        descReady: 'Зарегистрируйте четыре стандартные модели управляемого сервиса для чата, поиска, реранкинга и зрения.',
      ...
      addModelsDisplayName: {
        chat: 'Управляемый сервис Chat',
        embedding: 'Управляемый сервис Embedding',
        rerank: 'Управляемый сервис ReRank',
        vllm: 'Управляемый сервис Vision',
      },
    },
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать на платформу Q&A нефрологии больницы Чжуншань',
  ...
  auth: {
    ...
    firstTime: 'Впервые на платформе?',
  ...
  createChat: {
    title: 'Здравствуйте, я ассистент Q&A нефрологии больницы Чжуншань',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Управляемый сервис парсинга',
          desc: 'Парсинг документов через управляемый сервис',
        },
        markitdown: {
          name: 'MarkItDown',
