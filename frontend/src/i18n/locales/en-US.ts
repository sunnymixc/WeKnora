export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Welcome to Zhongshan Hospital Nephrology Q&A Platform',
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and the platform parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  localImport: {
    menuLabel: 'Import from server',
    title: 'Import from server local file system',
    root: 'Root',
    empty: 'This directory is empty',
    manualLabel: 'Enter path manually',
    manualPlaceholder: 'Path relative to the import root, e.g. docs/report.pdf',
    manualTip: 'The path is relative to the server-configured import root and cannot escape it',
    loadFailed: 'Failed to load directory',
    selectRequired: 'Please select a file or enter a file path',
    importSuccess: 'Local file imported successfully',
    importFailed: 'Failed to import local file',
  },
  uploadConfirm: {
    ...
    localItemLabel: 'Server local file',
    localAdded: 'Local file added',
    localDuplicate: 'This local file is already in the list',
    addUrl: 'Add',
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Managed Parsing Service',
      description: 'Configure APPID and APPSECRET credentials for the managed model and document parsing service.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'Managed service credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'Managed service application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Managed service application secret',
      ...
      credentialConfigured: 'Managed service credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'Managed service credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'Managed service credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard managed-service models for chat, retrieval, reranking, and vision.',
      ...
      addModelsDisplayName: {
        chat: 'Managed Service Chat',
        embedding: 'Managed Service Embedding',
        rerank: 'Managed Service ReRank',
        vllm: 'Managed Service Vision',
      },
    },
  ...
  initialization: {
    ...
    welcome: 'Welcome to Zhongshan Hospital Nephrology Q&A Platform',
  ...
  createChat: {
    title: 'Hello, I am the Zhongshan Hospital Nephrology Q&A Assistant',
  ...
  embedPublish: {
    ...
    webhookUrlDesc: 'Optional. The platform POSTs message_sent / message_received events to this HTTPS endpoint.',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Managed Parsing Service',
          desc: 'Document parsing via the managed parsing service',
        },
        markitdown: {
          name: 'MarkItDown',
