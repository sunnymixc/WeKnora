export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，平台会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  localImport: {
    ...
    empty: "该目录为空",
    manualLabel: "手动输入路径",
    manualPlaceholder: "输入相对根目录的文件路径，例如 docs/report.pdf",
    manualTip: "路径相对于服务器配置的导入根目录，不能超出该目录范围",
    loadFailed: "加载目录失败",
    selectRequired: "请选择一个文件或输入文件路径",
    importSuccess: "本地文件导入成功",
    importFailed: "本地文件导入失败",
  },
  uploadConfirm: {
    title: "上传文档确认",
    fileList: "待上传文件",
    ...
    localItemLabel: "服务器本地文件",
    localAdded: "已添加本地文件",
    localDuplicate: "该本地文件已在列表中",
    addUrl: "添加",
  ...
  settings: {
    ...
    roleDenied: {
      ...
      title: "托管解析服务",
      description: "配置托管模型与文档解析服务的 APPID 和 APPSECRET 凭证。",
      viewDocs: "查看文档",
  ...
  embedPublish: {
    ...
    webhookUrlDesc: "可选。访客发消息与助手回复完成时，平台会向该 HTTPS 地址 POST 事件（message_sent / message_received）。",
